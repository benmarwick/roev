...
##7.4.01_Falconer1973_Mus_Fig7.6abc
#==========================================================================
cat(rep("\n",50))							#clear console
...
#-------------------------------------------- Plot mean control line w. stdev 
for (i in 1:24){
...
#-------------------------------------- Plot mean low selection line w. stdev  
for (i in 1:24){
...
#------------------------------------- Plot mean high selection line w. stdev  
for (i in 1:24){
...
bootresultd=TriPanelBC(idrxL,"r",1,4.5,bootn,mode,psize,"lower")
wrlb.d=bootresultd[[1]];bootmat.d=bootresultd[[2]]
proc.time()-ptm
#========================================================== Plot LRI panel c
#send idrx matrix, n, mode(diff/rate), panel placement coordinates, mode
bootresultr=TriPanelBC(idrxS,"r",13,4.5,bootn,mode,psize,"lower")
...
text(0,6.5,"Six high selection lines",pos=4,cex=1.3,col=1)
text(12,6.5,"Six low selection lines",pos=4,cex=1.3,col=1)
