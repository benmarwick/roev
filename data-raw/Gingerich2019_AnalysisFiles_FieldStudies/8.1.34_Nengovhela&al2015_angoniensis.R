...
##8.1.34_Nengovhela&al2015_angoniensis
#==========================================================================
cat(rep("\n",50))							#clear console
...
#============================================================ Load file
file1<-"C://R_aaROEVchapt08//8.1.34_Nengovhela&al2015_angoniensis.csv"
...
table(LN[,2],LN[,2])
for (i in 1:5){
  if (i==1){r=c(1,23)}					#1906 to 1940
  if (i==2){r=c(24,50)}					#1948 to 1958
  if (i==3){r=c(51,89)}					#1967 to 1978
  if (i==4){r=c(90,108)}				#1982 to 1996
  if (i==5){r=c(109,130)}				#2002 to 2012
...
nrow(idr);nrow(idrx)
writefile<-"C://R_aaROEVchapt08//8.1.34_Nengovhela&al2015_angoniensis_out.csv"
