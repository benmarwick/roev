...
##9.2.18_Bell&al1985_Gasterosteus
#==========================================================================
cat(rep("\n",50))							#clear console
...
dev.size('in')
#============================================================ Load file
file1<-"../Gingerich2019_AnalysisFiles_FossilStudies/9.2.18_Bell&al1985_Gasterosteus.csv"
B<-read.csv(file1,header=TRUE,sep=",",quote="\"",dec=".",fill=TRUE)
B[1:5,];nrow(B);ncol(B)
#------------------------------------------------------Logged matrix
#cn=1;rn=3		#column number; row number
...
#==========================================================================
LB[,1:4]
SP2=LB[21:26,1:4];SP2
SPt=LB[20:21,1:4];SPt
SP1=LB[1:20,1:4];SP1
...
#writefile<-"C://R_aaROEVchapt09//9.2.18_Bell&al1985_Gasterosteus1_out.csv"
...
text(8.5,14.3,paste('highest rate: ',round(tr_psd_sd,digits=2),
  ...
  pos=4,cex=1,col=1)
points(idrxt[4]+1,idrxt[6]+7.5,pch=19,cex=1.1,col=1)
text(idrxt[4]+1,idrxt[6]+7.5,'highest rate',pos=4,cex=1,col=1)
points(idrxt[4]+13,idrxt[6]+7.5,pch=19,cex=1.1,col=1)
text(idrxt[4]+13,idrxt[6]+7.5,'highest rate',pos=4,cex=1,col=1)

text(9.2,3.6,expression(paste("Samples 1-20")),pos=2,cex=1,col=1)
text(21.2,3.6,expression(paste("Samples 21-26")),pos=2,cex=1,col=1)
